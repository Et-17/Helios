...
import { frontend_column_names, columnkeys, type Company, shown_columns } from '@/companyManagement';
import { use_human_readable_column_names } from '@/Settings/settingsManagement';
</script>
